...
<head>
    ...
    <title>Quản lý chuyển kho</title>
                ...
                <section class="header-btn">
                    <div class="header-actions">
                            ...
                            <button class="btn-edit">
                                <span class="material-symbols-outlined" style="color: green; font-size: 15px;">download</span>
                                <span>Xuất</span>
                            </button>
                            <button class="btn-edit">
            ...
            <section class="order-management">
                <div class="filters">
                    ...
                    <div class="button-group" style="margin-left: auto; display: flex; gap: 5px;">
                        <button class="btn">
                            <span class="material-symbols-outlined" style="color: #FFFFFF; font-size: 15px;">trending_flat</span>
